...
![pic41](https://github.com/Julian22222/Clouds/blob/main/Azure/IMG/pic41.jpg)

If you have a physical server (physical machine) -> what you will do first is install Operating System, which have standard components like file system, some services, some ports and other configuration.
...
# Comparing VMs and Summarize of Virtual Machines

![pic50](https://github.com/Julian22222/Clouds/blob/main/Azure/IMG/pic50.jpg)
...
# Comparing VMs and VM Scale Sets (VMSS)
...
![pic44](https://github.com/Julian22222/Clouds/blob/main/Azure/IMG/pic44.jpg)
...
# Comparing Container Instances to VMs and VM Scale Sets
...
# Comparing Kubernetes service to Container Instances VMs and VM Scale Sets
...
# Comparing App Services with other services
...
# Comparing Function Apps with other services
